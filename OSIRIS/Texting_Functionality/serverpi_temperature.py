...
# 
# Continuously poll ThingSpeak server for temperature values and if they become abnormal,
...
def pollTemperature():
    ...
    #if the temperature value is every outside of acceptable range, send text message
    client.send_message({
                'from': '12504835024',
                'to': '16479936650',
